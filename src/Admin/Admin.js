...
function Admin() {
    ...
    <div className='admin'>
        <div className='row' id="admin-input-group">
            ...
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Nome Empresa</span>
                <input onChange={(e)=>{
            ...
            <button onClick={(e)=>{
              ...
              }} id="btnSendMessage" className="btn btn-secondary">INSERIR USUARIO</button>
        </div>
    </div>
    {/*componente futuro*/}
    ...
    <table class="table" id="table-users">
            <thead class="thead-dark">
                <tr>
                <th className='row-table' scope="col">ID</th>
                <th className='row-table' scope="col">NAME</th>
                <th className='row-table' scope="col">Email</th>
                <th className='row-table' scope="col">Site</th>
                <th className='row-table' scope="col">DELETAR</th>
                </tr>
            </thead>
            <tbody>
        {empresa == undefined?'':empresa.map((list)=>{
        return(
            <>
            <tr>
            ...
            <td>{list.site}</td>
            <td><button onClick={()=>{
                Api.post("https://tamarintec.herokuapp.com/delete-user", {id:list._id})
                    .then((res)=>{
